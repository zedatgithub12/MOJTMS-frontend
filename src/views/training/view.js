...
import { IconChalkboard, IconEdit, IconLanguage, IconPaperclip, IconTrash, IconUser } from '@tabler/icons';
...
const ViewTraining = () => {
    ...
    const handleDeletingTraining = () => {
        var Api = Connections.api + Connections.trainings + '/' + state?.id;
                    ...
                    <PageHeader
                        ...
                        optionChildrens={
                            <Box>
                                ...
                                <MenuItem onClick={() => handleDeletingTraining()} color={theme.palette.error.main}>
                                    <ListItemIcon>
