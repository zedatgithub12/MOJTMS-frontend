...
const Trainee = () => {
    ...
    const FetchTrainees = async () => {
        ...
        var Api =
            Connections.api +
            Connections.trainee +
            `?uid=${uid}&gender=${filters.gender}&age=${filters.age}&address=${filters.address}&department=${filters.department}&page=${
    ...
    return (
        ...
        >
            ...
            {openDialog && <AddTrainee open={openDialog} handleDialogClose={() => handleDialogClose()} refresh={() => FetchTrainees()} />}
