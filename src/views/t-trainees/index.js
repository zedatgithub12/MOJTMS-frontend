...
const TrainingTrainees = () => {
    ...
    const FetchTrainees = async () => {
        ...
        var Api =
            Connections.api +
            Connections.alltrainees +
            `?uid=${id}&from=${filters.from}&to=${filters.to}&age=${filters.age}&gender=${filters.gender}&department=${filters.department}&job_title=${filters.job_title}&page=${paginationModel.page}&limit=${paginationModel.pageSize}`;
    ...
    const handleReset = () => {
        setFilters({ ...filters, from: '', to: '', age: '', gender: '', department: '', job_title: '' });
    };
                            ...
                            <Box sx={{ minWidth: 340, paddingX: 3 }}>
                                ...
                                <Box sx={{ minHeight: 200, display: 'flex', flexDirection: 'column', marginTop: 3 }}>
                                    ...
                                    <TextField
                                        ...
                                        InputProps={{
                                            endAdornment: filters.from && (
                                                <IconButton onClick={() => handleClear('from')}>
                                                    <IconX size={18} />
                                                </IconButton>
                                            )
                                        }}
                                    ...
                                    <TextField
                                        ...
                                        onChange={handleFilterChange}
                                        InputProps={{
                                            endAdornment: filters.to && (
                                                <IconButton onClick={() => handleClear('to')}>
                                                    <IconX size={18} />
                                                </IconButton>
                                            )
                                        }}
                                    ...
                                    <FormLabel component="legend" sx={{ marginTop: 3, marginBottom: 0.5 }}>
                                        {t('Age, Above')}
                                    </FormLabel>
                                    <TextField
                                        name="age"
