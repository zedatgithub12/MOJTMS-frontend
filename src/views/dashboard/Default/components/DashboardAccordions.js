...
const DashboardAccordions = ({ trainings, categories, departments }) => {
    ...
    return (
        ...
        >
            <Accordion>
                <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="training-content" id="training-header">
                    <Typography>{t('Upcoming Trainings')}</Typography>
                </AccordionSummary>
                {trainings}
            </Accordion>
